...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', secrets.token_urlsafe(48))
...
TIME_ZONE = os.environ.get('BUSINESS_TIME_ZONE', 'Asia/Shanghai')
...
MAX_ATTACHMENT_SIZE = int(os.environ.get('MAX_ATTACHMENT_MB', '20')) * 1024 * 1024
